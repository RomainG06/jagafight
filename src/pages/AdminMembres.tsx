                ...
                <div className="flex flex-wrap gap-4 mb-6">
                    <div>
                        ...
                        <input
                            ...
                            className="bg-white/5 border border-white/10 text-[#F5F5F0] px-3 py-1.5 text-sm focus:outline-none focus:border-[#eb0071] w-56"
                        />
                    </div>
                    <div>
                        <label className={LABEL_INPUT}>Certificat</label>
                        <select value={filterCertif} onChange={e => setFilterCertif(e.target.value)} className={SELECT}>
