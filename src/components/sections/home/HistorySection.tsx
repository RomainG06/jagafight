                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-10 relative before:absolute before:left-4 before:top-2 before:bottom-2 before:w-px before:bg-[#8B0020]/30">
                        {[
                            {
                                year: 'Fondation',
                                text: "Fondée à Perpignan par Oualid OUMERZOUK, ancien légionnaire du 2e REP et champion du monde Nokento Full Fight 2017. L'école attire plus de 120 licenciés dès sa création.",
                            },
                            {
                                year: 'Transmission',
